...
public class Player {
    ...
    public static void loadImages() {
        ...
        for (int s = 0; s < facingList.length; s++) {
            ...
            try {
                img = ImageIO.read(new File("src/Corona2DGamePackage/images/player.png"));
            } catch (Exception i) {
    ...
    public void addPoints(int actionPoints) {
        this.points += actionPoints;
